...
class PracticeAgent(BaseAgent):
    ...
    def __init__(self, client, model):
        super().__init__(client, model, "practice")
    ...
    async def analyze(self, code: str, language: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        scope = get_agent_scope("practice") if diff_mode else ""

        system_prompt = get_agent_system_prompt("practice", {
            "scope": scope,
            "language": language,
        })
